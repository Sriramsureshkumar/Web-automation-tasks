...
driver.get("file:///home/sriram/Documents/automation-excel/form.html")  # Replace with the actual file path

# Find the input field and submit button and interact with them
input_field = driver.find_element("id", "inputField")  # Updated syntax
input_value = "Your Value"
input_field.send_keys(input_value)

submit_button = driver.find_element("id", "submitButton")  # Updated syntax
submit_button.click()
